...
//	private JLabel lblTotal = new JLabel();
	...
	public WinOrder() {
		...
		lblHotCoffee.setIcon(new ImageIcon(WinOrder.class.getResource("/img/hotcoffee.png")));
...
//					lblHotCoffee.setText("가격은");
		...
		lblIecCoffee.setIcon(new ImageIcon(WinOrder.class.getResource("/img/icecoffee.png")));
		...
		lblShake.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getClickCount() == 1){
					String amount = JOptionPane.showInputDialog("쉐이크 음료 갯수 입력 : ");
					String price = "5000";
					String total = Integer.toString(Integer.parseInt(price) * Integer.parseInt(amount));
		...
		lblShake.setIcon(new ImageIcon(WinOrder.class.getResource("/img/shake.png")));
		...
		lblTotalPrice.setBounds(609, 258, 200, 20);
...
//		lblTotalPrice.setText(total);
		...
		lblDrink.setIcon(new ImageIcon(WinOrder.class.getResource("/img/Drinks.png")));
		...
		lblCake.setIcon(new ImageIcon(WinOrder.class.getResource("/img/cheesecake.png")));
		...
		Amount.setBounds(538, 228, 60, 20);
		...
		lblTotalAmount.setBounds(610, 228, 200, 20);
...
//				int HotCoffee, IceCoffee, Shake, Drink, Cake, Price = 0;
				...
				sql = sql + DRAmount.getText().trim() + "','" + CAAmount.getText().trim() + "','" + lblTotalPrice.getText().trim();
				sql = sql + "'," + "'카드'" + ",sysdate()" + ")";
