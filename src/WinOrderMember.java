...
public class WinOrderMember extends JDialog {
...
//	private JLabel lblTotal = new JLabel();
	...
	public static void main(String[] args) {
		try {
			WinOrderMember dialog = new WinOrderMember(null, null, null);
	 ...
	 * Create the dialog.
	 */
	public WinOrderMember(String name, String phone, String point) {
		Sname = name;
		Sphone = phone;
		Spoint = point;
		setTitle("메뉴 선택");
		...
		lblHotCoffee.setIcon(new ImageIcon(WinOrderMember.class.getResource("/img/hotcoffee.png")));
...
//					lblHotCoffee.setText("가격은");
		...
		lblIecCoffee.setIcon(new ImageIcon(WinOrderMember.class.getResource("/img/icecoffee.png")));
		...
		lblShake.setIcon(new ImageIcon(WinOrderMember.class.getResource("/img/shake.png")));
...
//		lblTotalPrice.setText(total);
		...
		lblDrink.setIcon(new ImageIcon(WinOrderMember.class.getResource("/img/Drinks.png")));
		...
		lblCake.setIcon(new ImageIcon(WinOrderMember.class.getResource("/img/cheesecake.png")));
...
//						System.out.println(sql);
				...
				String sql3 = "UPDATE membertbl SET point = '" + Integer.toString(Integer.parseInt(Spoint) - Integer.parseInt(p));
				sql3 = sql3 + "' where phone='" + Sphone + "'";
...
//				int HotCoffee, IceCoffee, Shake, Drink, Cake, Price = 0;
		...
		JButton btnPoint = new JButton("포인트 사용");
		btnPoint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				OK();
				
				p = JOptionPane.showInputDialog("사용하실 포인트 입력 : ");
				lblPoint2.setText(p);
				...
				// 내일하자 포인트 
				int aaa = Integer.parseInt(MemPoint.getText())-Integer.parseInt(p) ;
				MemPoint.setText(Integer.toString(aaa)); 
		...
		btnPoint.setBounds(710, 345, 100, 23);
